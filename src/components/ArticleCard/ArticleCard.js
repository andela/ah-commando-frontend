...
export class ArticleCard extends Component {
  ...
  render() {
    ...
    const {
      image, title, author, description, comment, readTime, id, slug, bookmark,
    } = data;
        ...
        <div className="article-details">
          ...
          >
            ...
            <Icon
              ...
              style={{
                margin: '8px 1px auto auto',
                color: '#ffc700',
              }}
            />
            <label className="bookmark-icon">{bookmark}</label>
          </div>
        </div>
      </div>
    );
